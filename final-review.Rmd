...
1. It will cover the new material from Sections 6.1-6.5 (Orthogonality) and 7.1 (Symmetric Matrices) and 7.4 (SVD).
...
$T(\mathsf{x}) = \mbox{proj}_{\mathsf{u}} \mathsf{x}$. Recall that the null space of $T$ is the subspace $\mbox{ker}(T) = \{ \mathsf{x} \in \mathbb{R}^n \mid T(x) = \mathbf{0} \}$. Describe  $\mbox{ker}(T)$ as explicitly as you can.
