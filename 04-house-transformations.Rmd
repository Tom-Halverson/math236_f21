...
Next, we scale the house by 2 in the $x$-direction and by 3 in the $y$-direction. Notice that
$$
\begin{bmatrix} 2 & 0 \\ 0 & 3 \end{bmatrix}
\begin{bmatrix} x \\ y \end{bmatrix}
= \begin{bmatrix} 2 x \\ 3 y \end{bmatrix}.
$$
...
Now we reflect over the line y = x. Notice that this is done by the matrix below
$$
...
Your turn: See if you can find the reflections (1)  over the x-axis; (2) over the y-axis; and (3) through the origin, i.e., sending (x,y) to (-x,-y).
