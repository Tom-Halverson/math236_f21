...
## The Famous Halverson Numbers

In class, we considered the matrix $F$ that generates the Fibonacci numbers and used it to find a formula $f_n$ for the $n$th Fibonacci number. Here you are to follow the same process to find a formula $h_n$ for the nearly-as-famous Halverson numbers. 
