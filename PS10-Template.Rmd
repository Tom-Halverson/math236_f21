...
(Mon 11/29) On Exam 2 you found the basis below for the set of palindromic vectors in $\mathbb{R}^5$. Note that the basis is orthogonal.
$$
...
\right\}. \hskip5in
$$
Let $v = \begin{bmatrix} 1 \\ 2 \\ 3 \\ 4 \\ 5 \end{bmatrix}$.
